...
class UserController extends Controller
{
     ...
     */
       public function wallet($userId)
       {
        ...
        public function identificationVeriffComplete(Request $request)
        {
           /* $user = User::find(Auth::user()->id);
            ...
            //$this->helper->one_time_message('success', ''));
            */
        ...
        public function identificationVeriffProcess(Request $request)
        {
            
            Log::info($request);
          
            Log::info(json_encode($request->header()));
            Log::info(json_encode($request->action));
            Log::info(json_encode($request->vendorData));
            
            if($request->action == "submitted") {
                
                $user = User::where(['email' => $request->vendorData])->first();

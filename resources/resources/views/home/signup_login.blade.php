            ...
            @endif
				<form id="signup_form" name="signup_form" method="post" action="{{url('create')}}" class='signup-form login-form' accept-charset='UTF-8' onsubmit="return ageValidate();">
					...
					<div class="row text-16">
						...
						<div class="form-group col-sm-12 p-0">
                            <label for="first_name">{{ trans('messages.sign_up.last_name') }} <span class="text-13 text-danger">*</span></label>
						...
						<div class="form-group">
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="terms_of_service" name="terms_of_service" {{ old('terms_of_service') ? 'checked' : '' }}>
										I acknowledge that I have read, and do hereby accept the <a href="{{ url('/terms-of-service') }}" style="font-weight: 600">Terms of Service</a> and <a href="{{ url('/privacy-policy') }}" style="font-weight: 600">Privacy Policy</a>
                                    </label>
                                </div>
								@if ($errors->has('terms_of_service'))<p class="error-tag">{{ $errors->first('terms_of_service') }}</p>@endif
				...
				<div class="text-14">
					{{trans('messages.sign_up.already')}} {{ $site_name ?? 'RoomUnite' }} {{ trans('messages.sign_up.member') }}?

                                    ...
                                    <div class="col-md-6 col-xl-6 p-2">
                                        ...
                                        <p class="text-14 mt-3 text-muted mb-0">
                                            <i class="fas fa-map-marker-alt"></i>
                                             @if($property->property_address)
                                                ...
                                                <span> {{$property->property_address->state}}</span>
                                                
                                                <span>
                                                {{$property->property_address->postal_code}}, </span>
                                                
                                                <span>
                                                {{$property->property_address->country}}</span>
                                            @else
                                                N/A
                                            @endif
                                        </p>
                                        ...
                                        <div class="review-0 mt-4">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="pr-5">
                                                    @if($property->property_price && isset($currentCurrency))
                                                        <span class="font-weight-700 text-20">{!! moneyFormat( $currentCurrency->symbol, $property->property_price->price) !!}</span> / {{trans('messages.property_single.week')}}
                                                    @else
                                                        <span class="font-weight-700 text-20">N/A</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>

        ...
        <div class="col-lg-8 col-xl-9">
                ...
                <div class="d-flex border rounded-4 p-4 mt-4">
                    <div class="text-center">
                        <a href="{{ url('users/show/'.$result->host_id) }}">
                            <img alt="User Profile Image" class="img-fluid rounded-circle mr-4 img-90x90 lazy"
                    ...
                    <div class="ml-2">
                        ...
                        <span class="text-14 gray-text"><i class="fas fa-map-marker-alt"></i> {{
                            !empty($result->property_address) ? $result->property_address->city : '' }} @if(!empty($result->property_address) && $result->property_address->city !=''),@endif {{
                            !empty($result->property_address) ? $result->property_address->state : '' }} @if(!empty($result->property_address) && $result->property_address->state !=''),@endif {{
                            !empty($result->property_address) && !empty($result->property_address->countries) ? $result->property_address->countries->name : '' }}</span>
            ...
            <div class="row justify-content-center border rounded pb-5 mt-5 desktop" id="listMargin">
                <div class="col-md-12 mt-3 pl-4 pr-4">
                    ...
                    <div class="mt-3">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="mt-4 text-justify" style="white-space: pre-wrap;">{{ $result->property_description->summary ?? '' }}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div>
                                        ...
                                        <strong> <span id="weekly_price_string">{!! moneyFormat('',
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div>
                                        ...
                                        <strong>
                                            <span id="weekly_price_string">{!! moneyFormat('',
                    ...
                    @if(!empty($result->property_description) && (@$result->property_description->about_place !='' ||
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9" style="white-space: pre-line;">
                            @if(!empty($result->property_description) && $result->property_description->about_place)
                            ...
                            @if(!empty($result->property_description) && $result->property_description->place_is_great_for)
                            <strong
                            ...
                            <div class="d-none" id='description_after'>
                                @if(!empty($result->property_description) && $result->property_description->interaction_guests)
                                <strong
                                ...
                                @if(!empty($result->property_description) && $result->property_description->about_neighborhood)
                                <strong
                                ...
                                @if(!empty($result->property_description) && $result->property_description->guest_can_access)
                                <strong
                                ...
                                @if(!empty($result->property_description) && $result->property_description->get_around)
                                <strong
                                ...
                                @if(!empty($result->property_description) && $result->property_description->other)
                        ...
                        <div class="col-md-9 col-sm-9">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div><strong>{{ $result->cancellation_policy_title ? $result->cancellation_policy_title : 'N/A' }}</strong></div>

                                    <p class="mt-4 text-justify" style="white-space: pre-wrap;">{{ $result->cancellation_policy_desc ? $result->cancellation_policy_desc : 'N/A' }}</p>
                                </div>
                                ...
                                @elseif($i <= 4) @if($i==4) <div class="p-2 position-relative">
                                    <div class="view-all gal-img h-110px">
                                        <img src="{{url('public/images/property/'.$property_id.'/'.$row_photos->photo)}}"
                                            alt="property-photo" class="img-fluid h-110px rounded lazy"
                                            onclick="lightbox({{$i}})" />
                            ...
                            <div class="">
                                <div class="media-photo-badge text-center">
                                    <a href="{{ url('users/show/'.$row_review->users->id) }}"><img
                                            alt="{{ $row_review->users->first_name }}" class="lazy"
                        ...
                        <div class="">
                            <div class="media-photo-badge text-center">
                                <a href="{{ url('users/show/'.$result->host_id) }}"><img
                                        alt="{{ $result->users->first_name }}" class="lazy"
            ...
            <div class="" id="booking-banner" class="">
                <div class="secondary-bg rounded">
                    <div class="col-lg-12">
                        <div class="row justify-content-between p-3">
                            ...
                            <div class="text-white text-14 font-semibold">
                                <div id="per_night" class="per-night">
                                    {{trans('messages.property_single.per_week')}}
                                </div>
                ...
                <div class="col-lg-12 mt-4 px-0">
                    <div class="d-flex align-items-center">
                         <i class="fa fa-exclamation-triangle text-warning mr-3" aria-hidden="true"></i>
                        <p class="text-warning text-12 mb-0" style="line-height: 1.2;">Rates are charged on a weekly basis. Therefore picking certain amount of days will charge as a full week.</p>
                    </div>
                </div>
            </div>
                ...
                <form accept-charset="UTF-8" method="post" action="{{ url('payments/book/'.$property_id) }}"
                    ...
                    <div class="row">
                        <div class="col-md-12  p-4 single-border border-r-10 ">
                            <div class="row p-2">
                                <div class="col-6 p-0" id="datestart-btn">
                                    ...
                                    <div class="mr-2">
                                        <input class="form-control" id="startDate" name="checkin"
                                           value="{{ $checkin ? $checkin : '' }}"
                                            placeholder="Pick a date" type="text" required>
                                    </div>
                                </div>
                                <!--
                                ...
                                <div class="col-6 p-0" id="dateend-btn">
                                ...
                                <div class="col-12 p-0" id="error-area">
                                    <span style="color:red;font-size:12px;"></span>
                                </div>
                            </div>
                            <div class="px-2">
                                 @if($result->min_days > 0)
                                     <p class="text-danger text-12" style="line-height: 1.2;">Property only allows a minimum of {{$result->min_days}} days stay</p>
                                @endif
                    ...
                    <div id="book_it" class="mt-4">
                        <div class="js-subtotal-container booking-subtotal panel-padding-fit">
                            <div id="loader" class="display-off single-load">
                                <img src="{{URL::to('/')}}/public/front/img/green-loader.gif" class="lazy" alt="loader">
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="pl-4 w-50">
                                                ...
                                                {{trans('messages.property_single.weeks')}}
                                       ...
                                       <!-- <tr class="security_price">
                                        ...
                                        <tr class="cleaning_price">
                                         ...
                                         <tr class="damages_insurance">
                                            <td class="pl-4">
                                                Damages Insurance
                                            </td>
                                            <td class="pl-4 text-right"><span id="damages_insurance" value=""> 0 </span></td>
                                        </tr>
                        ...
                        <div id="book_it_disabled" class="text-center d-none">
                            ...
                            <a href="{{URL::to('/')}}/search?location={{!empty($result->property_address) ? $result->property_address->city : '' }}"
                ...
                <div class="grid">
                    <a href="{{ $row_similar->slug }}">
                        <figure class="effect-milo">
                            <img src="{{ $row_similar->cover_photo }}" class="room-image-container200 lazy" alt="img11" />
                    ...
                    <div class="d-flex">
                        <div>
                            <div class="profile-img pl-2 pr-1">
                                <a href="{{ url('users/show/'.$row_similar->host_id) }}"><img
                                        src="{{ !empty($row_similar->users) ? $row_similar->users->profile_src : asset('images/default-profile.png') }}" class="lazy" alt="profile-photo"></a>
                            </div>
                        </div>
                        ...
                        <div class="p-2 text">
                            ...
                            <p class="text-14 mt-2 mb-0 text"><i class="fas fa-map-marker-alt"></i>
                                {{!empty($row_similar->property_address) ? $row_similar->property_address->city : 'N/A'}}</p>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <span class="font-weight-700">
                                    @php
                                        $similar_price = optional($row_similar)->property_price;
                                        $similar_currency = optional($similar_price)->currency;
                                    @endphp
                                    @if($similar_price && $similar_currency)
                                        {!! moneyFormat($similar_currency->symbol, $similar_price->price) !!}
                                    @elseif($similar_price)
                                        {{ $symbol ?? '$' }}{{ $similar_price->price ?? '0' }}
                                    @else
                                        {{ $symbol ?? '$' }}0
                                    @endif
...
<script type="text/javascript">
	...
	$(function() {
		...
		var page = 'single'
		/*dateRangeBtn(checkin,checkout,page,'{{$date_format}}', '{{$result->max_days}}', '{{$result->min_days}}'); */
		
		dateStartRangeBtn(checkin, page, '{{$date_format}}');
		dateEndRangeBtn(checkin, checkout, page, '{{$date_format}}', '{{$result->min_days}}',  '{{$result->max_days}}');
			...
			success: function (result) {
				...
				/*	for(var i=0; i<result.date_with_price.length; i++){
					...
					*/
					...
					for(var i=0; i<result.weeks_with_price.length; i++){

					append_date +=		'<tr class="append_date">'
											+ '<td class="pl-4">Week '
												+ result.weeks_with_price[i]['week']+
											'</td>'
											+ '<td class="pl-4 text-right"> <span  id="" value="">$ ' + result.weeks_with_price[i]['price'] +'</span></td>'
										+ '</tr>';
				...
				//	$("#total_night_count").html(result.total_nights);
				    $("#total_night_count").html(result.total_weeks);
				//	$('#total_night_price').html(result.total_night_price_with_symbol);
					
					$('#total_night_price').html(result.week_data_total_price_with_symbol);
					
				//	$('#service_fee').html(result.service_fee_with_symbol);
					$('#service_fee').html(result.week_data_service_fee_with_symbol);
					
					//$('#discount').html("- " + result.discount_with_symbol);
					
					$('#discount').html("- " + result.week_data_discount_with_symbol);
					...
					*/
					...
					if(result.week_data_accomodation_tax != 0) $('#accomodation_tax').html(result.week_data_accomodation_tax_with_symbol);
					else $('.accomodation_tax').addClass('d-none');
					...
					if(result.damages_insurance != 0) $('#damages_insurance').html(result.damages_insurance_with_symbol);
					else $('.damages_insurance').addClass('d-none');
					
					//$('#total').html(result.total_with_symbol);
					$('#total').html(result.week_data_total_with_symbol);
...
setTimeout(function(){
	...
	$('#room-detail-map').locationpicker({
		location: {
			latitude: "{{!empty($result->property_address) ? $result->property_address->latitude : '0'}}",
			longitude: "{{ !empty($result->property_address) ? $result->property_address->longitude : '0' }}"
		},
		radius: 0,
		addressFormat: "",
		markerVisible: false,
...
function setCircle(map){
	...
	var cityCircle = new google.maps.Circle({
		...
		fillOpacity: 0.35,
		map: map,
		center: {lat: {{!empty($result->property_address) ? $result->property_address->latitude : '0'}}, lng: {{ !empty($result->property_address) ? $result->property_address->longitude : '0' }} },

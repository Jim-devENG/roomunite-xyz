                        ...
                        <ul class="list-inline  pl-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-room-type" aria-labelledby="dropdownRoomType">
                                    <div class="row p-3">
                                        @foreach($space_type as $rws=>$value)
                                            <div class="col-md-12">
                                                ...
                                                @if($rws==2)
                                                    <div class="d-flex justify-content-between pr-4">
                                                        <div>
                                                            <p class="text-16"><i class="icon icon-private-room"></i> {{ $value }}</p>
                                                        </div>
                                                        <div>
                                                            <input type="checkbox" id="space_type_{{ $rws }}" name="space_type[]" value="{{ $rws }}" class="form-check-input" {{ in_array($rws, $space_type_selected)?'checked':'' }}>
                                                        </div>
                                                ...
                                                @if($rws==3)
                                                    <div class="d-flex justify-content-between pr-4">
                                                        <div>
                                                            <p class="text-16"><i class="icon icon-shared-room"></i> {{ $value }}</p>
                                                        </div>
                                                        <div>
                                                            <input type="checkbox"  id="space_type_{{ $rws }}" name="space_type[]" value="{{ $rws }}" class="form-check-input" {{ in_array($rws, $space_type_selected)?'checked':'' }}>
                                                        </div>
                                        ...
                                        <div class="col-md-12 text-right mt-4">
                                            <button class="btn vbtn-success text-16 font-weight-700  rounded" id="btnRoom">{{trans('messages.utility.submit')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-inline-item  mt-4">
                                ...
                                <div class="dropdown-menu caed-raise dropdown-menu-room-type" aria-labelledby="dropdownRoomType">
                                    <div class="row p-3">
                                        ...
                                        <div class="col-md-12 text-right mt-4">
                                            <button class="btn vbtn-success text-16 font-weight-700  rounded" id="btnBook">{{trans('messages.utility.submit')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-inline-item  mt-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-price p-4" aria-labelledby="dropdownPrice">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right mt-4">
                                            <button class="btn vbtn-success text-16 font-weight-700  rounded" id="btnPrice">{{ trans('messages.utility.submit') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body modal-body-filter">
                            ...
                            <div class="row mt-3">
                             ...
                             <div class="row mt-5">
                                <div class="col-sm-12">
                                    <h5 class="font-weight-700 text-24 pl-4" for="user_birthdate">Furnishing</h5>
                                </div>
                                
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="select col-sm-4">
                                            <select name="furnishing" class="form-control" id="map-furnishing">
                             ...
                             <div class="row mt-5">
                                <div class="col-sm-12">
                                    <h5 class="font-weight-700 text-24 pl-4" for="user_birthdate">Stay Duration</h5>
                                </div>
                            ...
                            if (properties.hasOwnProperty(key)) {
                                ...
                                if(properties[key].reviews_count == 1) reviews_count = properties[key].reviews_count;
                                    ...
                                    if (divCol == false) {
                                        ...
                                        properties[key].property_address.city + ',<span> ' +                            properties[key].property_address.state + '</span> ' + '<span> ' +
                                            properties[key].property_address.postal_code +',</span> ' + ' <span>' +
                                             properties[key].property_address.country + '</span>' +
                                        ...
                                        +'<a class="btn btn-sm book_mark_change" data-status="'+properties[key].book_mark +'" data-id="'+properties[key].id+'" style="color:'+ color +'">'
                                            ...
                                            +'</div>'
                                                                    +'</div>'
                                                                    +'<div>'
                                                                        +'<span class="font-weight-700 text-18">'+symbolWithPrice+'</span> / {{trans('messages.property_single.week')}}'
                                                                    +'</div>'
                                                                +'</div>'
                                                            +'</div>'
                                                                ...
                                                                +'<div class="d-flex bg-white justify-content-between pl-2 pr-2 pt-2 mb-3">'
                                                                    ...
                                                                    +'<ul class="list-inline">'
                                                                        +'<li class="list-inline-item  pl-4 pr-4 border rounded-3 mt-1 bg-light text-dark">'
                                                                            ...
                                                                            +'<span class="vtooltiptext text-14">'+properties[key].accommodates +' {{trans('messages.property_single.guest')}}</span>'
                                                                        +'</div>'
                                                                    +'</li>'
                                                                        ...
                                                                        +'<div class="vtooltip"> <i class="fas fa-bed"></i> '+properties[key].bedrooms+''
                                                                            +'<span class="vtooltiptext  text-14">' +properties[key].bedrooms+' {{trans('messages.property_single.bedroom')}}</span>'
                                                                        +'</div>'
                                                                        +'</li>'

                                                                        +'<li class="list-inline-item pl-4 pr-4 border rounded-3 mt-1 bg-light">'
                                                                        +'<div class="vtooltip"> <i class="fas fa-bath"></i> '+' '+properties[key].bathrooms+''
                                                                            +'<span class="vtooltiptext  text-14 p-2">'+properties[key].bathrooms+' {{trans('messages.property_single.bathroom')}}</span>'
                                                                        +'</div>'
                                                                        +'</li>'
                                                                    +'</ul>'
                                                                    +'</div>'
                                        ...
                                        properties[key].property_address.city + ',<span> ' + properties[key].property_address.state + '</span> ' + '<span> ' +
                                            ...
                                            +'</div>'
                                                                    ...
                                                                    +'<div>'
                                                                        +'<span class="font-weight-700 text-20">'+symbolWithPrice+'</span> / {{trans('messages.property_single.week')}}'
                                                                    +'</div>'
                                                                +'</div>'
                                                            +'</div>'
                                                            ...
                                                            +'<ul class="list-inline mt-2 pb-3">'
                                                                +'<li class="list-inline-item border rounded-3 p-1 mt-4 pl-3 pr-3">'
                                                                    +'<p class="text-center mb-0">'
                                                                        ...
                                                                        +'<span class=" text-14 font-weight-700"> {{trans('messages.home.guest')}}</span>'
                                                                    +'</p>'
                                                                +'</li>'
                                                                +'<li class="list-inline-item  border rounded-3 mt-4 p-1  pl-3 pr-3">'
                                                                    +'<p  class="text-center mb-0" >'
                                                                        ...
                                                                        +'<span class=" text-14 font-weight-700"> {{trans('messages.property_single.bedroom')}}</span>'
                                                                    +'</p>'
                                                                +'</li>'
                                                                +'<li class="list-inline-item  border rounded-3 mt-4 p-1  pl-3 pr-3">'
                                                                    +'<p  class="text-center mb-0">'

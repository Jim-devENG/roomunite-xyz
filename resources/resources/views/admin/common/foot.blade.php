...
<!-- jQuery 2.2.4 -->
<script type="text/javascript" src="{{ asset('backend/plugins/jQuery/jquery-2.2.4.min.js') }}"></script>
<!-- jQuery UI 1.11.4 -->
<!-- jQuery validation -->
...
<!-- admin js -->
<script type="text/javascript" src="{{ asset('backend/dist/js/admin.js') }}"></script>
<!-- backend js -->

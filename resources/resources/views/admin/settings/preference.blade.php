            ...
            <form id="preferencesform" method="post" action="{{ url('admin/settings/preferences')}}" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  {{-- min_price --}}
                  <div class="form-group">
                      <label for="exampleInputPassword1" class="control-label col-sm-3">Search Price (Min)<span class="text-danger">*</span></label>
                      <div class="col-sm-6">
                          <input type="number" name="min_search_price" value="{{isset($result['min_search_price'])? $result['min_search_price']: 0}}" class="form-control" id="min_price">
                          <small>In default currency</small>
                      </div>
                  </div>
                  {{-- max_price --}}
                  <div class="form-group">
                      <label for="exampleInputPassword1" class="control-label col-sm-3">Search Price (Max)<span class="text-danger">*</span></label>
                      <div class="col-sm-6">
                          <input type="number" value="{{isset($result['max_search_price'])? $result['max_search_price']: 1000}}" name="max_search_price" class="form-control" id="max_price">

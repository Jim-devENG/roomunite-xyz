				...
				<div style="width:10%; float:left;font-size:15px; color:#383838; font-weight:400;">
					<div>
						@if (!empty($companyLogo))
							@if (isset($logo_flag))
								<img src='{{asset("front/front/images/default-error-image.png")}}' max-width="120" max-height="80">
							@else
								<img src='{{asset("front/front/images/logos/$companyLogo")}}' max-width="120" max-height="80">
							@endif
						@endif
					</div>
				</div>

                ...
                <div class="modal-content">
                  ...
                  <form method="post" action="admin/hotel_date_package/" class='form-horizontal' id='dtpc_form'>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label for="input_dob" class="col-sm-3 control-label">Minimum Stay </label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="min_stay" id='dtpc_minstay_admin' placeholder = "">
                          <span class="text-danger" id="error-dtpc-minstay">{{ $errors->first('minstay') }}</span>
                        </div>
                      </div>

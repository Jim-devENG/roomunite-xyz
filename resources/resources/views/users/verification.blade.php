				...
				<div class="container-fluid min-height">
					<div class="col-md-12">
						...
						<div class="row justify-content-center mt-5">
								...
								<div class="main-panel border main-panelbg">
									...
									<ul class="list-layout edit-verifications-list">
										...
										@else
											...
											<li class="edit-verifications-list-item">
												<h4 class="font-weight-700 text-16">Identity Verification</h4>
												<p class="pl-4">Your identity has successfully been confirmed. You have now been elevated to a tier 2 user and can access all features.
												</p>
											</li>
											@endif
											<hr>
							...
							<div class="card card-default">
								@if(!(Auth::user()->users_verification->email == 'yes' && Auth::user()->users_verification->facebook == 'yes' && Auth::user()->users_verification->google == 'yes' && Auth::user()->verified == 1))
								...
								<div class="p-4">
	                                ...
	                                @if(Auth::user()->verified == 0)
    									<li>
    											...
    											<div class="row pl-4 pt-2">
    												<div class="col-md-9">
    												    <p class="description text-16"> Verify your identity with government approved identity cards       
    												    </p>
    												</div>
    												
    												<div class="col-md-3">
    												    <div id='veriff-root' style="width:200px"></div>
    												</div>
    											</div>
	...
	@push('scripts')
	   ...
	   <!--<script src='https://cdn.veriff.me/incontext/js/v1/veriff.js'></script>-->
	    ...
	    <script type="text/javascript">
	        ...
	        var f_name = {!! json_encode(Auth::user()->first_name) !!};
            var l_name = {!! json_encode(Auth::user()->last_name) !!};
            var email_address = {!! json_encode(Auth::user()->email) !!};
            
	        const veriff = Veriff({
    	        host: 'https://stationapi.veriff.com',
                apiKey: 'fd1cf270-0459-41c3-8dcb-b87bae22aafc',
